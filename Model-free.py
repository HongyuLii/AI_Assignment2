...
with open(os.path.join(sys.path[0], "a2test"), "r") as f:
...
while i < episodes:
    ...
    while not done:
        ...
        result_state = random.choices(result_states[index_of_state][index_of_action],
                                     result_probabilities[index_of_state][index_of_action])
        ...
        new_q = (1 - learning_rate) * current_q + learning_rate*(1+discount * future_q)
